  ...
  return (
    <main className="bg-white text-gray-800 font-sans leading-relaxed antialiased">
      ...
      <section className="w-full bg-white py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <p className="text-xl sm:text-2xl font-light italic max-w-xl text-gray-700 mt-4">
              “A Legacy of Compassion Honoring Every Life Every Moment.”
            </p>
          </div>

          {/* IMAGE */}
          <div className="relative w-full h-[350px] sm:h-[450px] rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="/heroabout.png"
      ...
      <section className="grid md:grid-cols-2 items-center gap-10 px-6 md:px-12 py-24 max-w-7xl xl:max-w-8xl mx-auto border-b border-gray-100">
        ...
        <div className="relative h-[350px] sm:h-[450px] w-full rounded-xl shadow-xl overflow-hidden">
          <Image
            src="/about3.png"
            alt="Welcome Image"
            fill
        ...
        <div>
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            it’s about cherishing what matters most—comfort, dignity, and connection.
          </p>
      ...
      <div className="bg-[#F9FAF9] py-20 px-6 md:px-12">
        ...
        <section className="grid md:grid-cols-2 items-center gap-10 max-w-7xl mx-auto pb-20">
          ...
          <div className="p-4">
            <h2 className="text-3xl font-bold mb-4" style={gradientHeading}>
              Our Mission
            </h2>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-white shadow-2xl rounded-3xl p-10 border border-gray-100">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-2xl font-bold" style={gradientHeading}>
                Our Core Values
              </h3>
            </div>
            ...
            <ul className="space-y-2 pl-5 list-disc text-gray-700">
              <li className="font-semibold text-[#03271E]">
                Compassion: We lead with empathy.
              </li>
              <li className="font-semibold text-[#03271E]">
                Dignity: We honor every patient.
              </li>
              <li className="font-semibold text-[#03271E]">
                Integrity: We operate with transparency.
              </li>
              <li className="font-semibold text-[#03271E]">
                Family: One circle of care for all.
              </li>
              <li className="font-semibold text-[#03271E]">
                Hope: We foster emotional and spiritual peace.
              </li>
            </ul>
          </div>
