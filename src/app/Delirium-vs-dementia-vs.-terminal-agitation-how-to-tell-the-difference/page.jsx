    ...
    >
      ...
      >
        ...
        <h2 className="text-2xl font-bold mb-4 text-[#006D66]">
          1. Dementia: The Long Background
        </h2>
        <p className="text-lg leading-relaxed mb-6 text-justify">
        ...
        <p className="text-lg leading-relaxed mb-6 text-justify">
          The hallmark of delirium is fluctuating consciousness and inattention. The patient may be lucid one hour and completely disoriented the next. This can manifest as hyperactive delirium agitation or hallucinations or hypoactive delirium withdrawn or sluggish which is often mistaken for depression.
        </p>

        <h2 className="text-2xl font-bold mb-4 text-[#006D66]">
          3. Terminal Agitation: The Final Transition
        </h2>
        <p className="text-lg leading-relaxed mb-6 text-justify">
          ...
          <table className="min-w-full text-left border-collapse text-sm md:text-base">
            <thead>
              <tr className="bg-gray-50">
                <th className="p-3 md:p-4 font-bold border-b">Feature</th>
                <th className="p-3 md:p-4 font-bold border-b">Dementia</th>
                <th className="p-3 md:p-4 font-bold border-b">Delirium</th>
                <th className="p-3 md:p-4 font-bold border-b">
                  Terminal Agitation
                </th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="p-3 md:p-4 border-b font-semibold">Onset</td>
                <td className="p-3 md:p-4 border-b">Years Slow</td>
                <td className="p-3 md:p-4 border-b">Hours Days Sudden</td>
                <td className="p-3 md:p-4 border-b">Days Hours</td>
              </tr>
              <tr>
                <td className="p-3 md:p-4 border-b font-semibold">Attention</td>
                <td className="p-3 md:p-4 border-b">Normal until late</td>
                <td className="p-3 md:p-4 border-b">
                  Impaired Fluctuating
                </td>
                <td className="p-3 md:p-4 border-b">Severely Impaired</td>
              </tr>
              <tr>
                <td className="p-3 md:p-4 border-b font-semibold">
                  Reversibility
                </td>
                <td className="p-3 md:p-4 border-b">Irreversible</td>
                <td className="p-3 md:p-4 border-b">Often Reversible</td>
                <td className="p-3 md:p-4 border-b">Irreversible</td>
              </tr>
              <tr>
                <td className="p-3 md:p-4 font-semibold">Primary Goal</td>
                <td className="p-3 md:p-4">Quality of life</td>
                <td className="p-3 md:p-4">Treat the cause</td>
                <td className="p-3 md:p-4">Symptom Comfort</td>
              </tr>
            </tbody>
          </table>
        </div>
