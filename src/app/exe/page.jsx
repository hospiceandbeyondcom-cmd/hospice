      ...
      <section className="bg-white py-20 px-6 text-center rounded-t-[3rem]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 mb-10 text-lg">
            Our 30-day series deepens the conversation around spiritual distress and the "Total Pain" model.
          </p>
          <motion.a
            whileHover={{ scale: 1.05 }}
            href="https://hospiceandbeyond.com/spiritual-distress-and-the-role-of-chaplain-support"
